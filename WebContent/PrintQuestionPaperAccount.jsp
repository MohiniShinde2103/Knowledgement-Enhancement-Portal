...
<title>Print Question Paper Account</title>
</head>
...
<form action="printquestionfinal.jsp" target="_blank">
<fieldset id="registration">
                    <font color="#ffffff" font size=4px>
<div class="heading1"><h1>Print Question Paper Account</h1></div></br></br>
	<%@ page import="java.io.*"%>
