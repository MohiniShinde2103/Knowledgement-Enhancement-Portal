...
<form action="packingslipfinal.jsp" method="get" target="_blank">  
<fieldset id="registration">
   <font color="#ffffff" font size=4px>
<div class="heading1"><h1>Print Packing Slip</h1></div></br></br>
<%@ page import="java.io.*"%>
...
ResultSet rs2=st.executeQuery("select * from examstudent");
out.println("Select Course-Sem / Year-Master code : <select id=\"button\" name=\"class1\">");
while(rs2.next())
{
	if(rs2.previous())
	{
		previ=rs2.getString(4);
	}
	rs2.next();
	new1=rs2.getString(4);
	if(previ.equals(new1))
	{
		continue;
	}
	...
	{
		out.println("<option>");
		out.println(rs2.getString(8)+" "+rs2.getString(9)+" "+rs2.getString(10));
		out.println("</option>");
	}
}
out.println("</select><br/><br/>");
