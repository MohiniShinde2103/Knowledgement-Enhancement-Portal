...
<form action="searchsubjectfinal.jsp" target="_blank">
<fieldset id="registration">
<font color="white" font size=5px>
     <table class="table1">
	<tr><td><a href="#"><input type="button" name="insert" value="Search Subject" id="butt1"/></a></td><td></td><td></td>
	<tr><td>Search By*:&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</td>
	<td><select name="search1"><option>Id</option><option>subject code</option></select></td></tr>
