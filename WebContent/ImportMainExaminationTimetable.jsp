...
<title>Import Main Exam Timetable</title>
</head>
...
<font color="white" fontsize=5px>
     <table class="table1">
	<tr><td><a href="#"><input type="button" name="insert" value="Insert Main Examination Table" id="butt12"/></td><td></td><td></td>
	<tr><td><b>Import Main Seating Chart CSV/Excel file</b></td></tr>
	<tr><td>Choose Main Seating CSV/Excel File to Upload:  </td>
	<td>
	<form action="inserttimetablecsv.jsp" method="post">
	...
	<td><a href="deletetimetablecsv.jsp"><input type="button" name="del"  id="button" value="Delete"></a></td></tr>
	
</table>	
</font>
<br><hr><br><br>
	<form action="exporttimetable.jsp">
