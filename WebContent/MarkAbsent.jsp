...
<form action="markabsentfinal.jsp">
<fieldset id="registration">
                     <font color="#ffffff" font size=4px>
<div class="heading1"><h1>Mark Absent</h1></div></br></br>
<%@ page import="java.io.*"%>
...
ResultSet rs2=st.executeQuery("select * from examblocks");
out.println("Select Block : <select id=\"button\" name=\"block\">");
while(rs2.next())
{
		out.println("<option>");
