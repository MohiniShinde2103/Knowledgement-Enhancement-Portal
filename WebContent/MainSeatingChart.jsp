...
<title>Main Seating Chart</title>
</head>
...
<table>
<tr><td><a href="SearchStudent.jsp"><input type="button" name="search" value="Search Student" id="butt1" /></a></td><td>
<input type="submit" name="edit" value="Edit Student" id="butt1" /></td><td>
<input type="submit" name="edit" value="Delete Student" id="butt1" /></td></tr>
</table>
...
out.println("<table border=2 width=\"100%\"><h4><tr><td>Sr. No.</td><td>Date</td><td>Time</td><td>Subject Code</td><td>Subject Name</td><td>Seat No.</td><td>Center</td><td>Sem</td><td>Select</td></tr></h4>");
...
while(rs.next())
{
	...
	out.println("<td>"+rs.getString(8)+" "+rs.getString(9)+" "+rs.getString(10)+"</td><td><input type=\"radio\" name=\"radio1\" value=\""+rs.getString(1)+"\"></td></tr>");
}
out.println("</table>");
%>
</font>
