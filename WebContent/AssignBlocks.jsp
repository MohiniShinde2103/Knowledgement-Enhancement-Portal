...
<form action="assignmain.jsp">
<fieldset id="registration">
    <font color="#ffffff" font size=4px>               
<div class="heading1"><h1>Select Date and Time to Assign blocks</h1></div></br></br>
...
ResultSet rs=st.executeQuery("select * from examtimetable where remcount>0");
String previ="",new1;
...
out.println("</select>");
ResultSet rs1=st.executeQuery("select * from examtimetable where remcount>0");
