...
Change Password</div>
  <div class="nav">
<ul>     <li>  <a  href="adminmain.html">Home |</a> </li>
<li>  <a  href="studentprofile.html">Student Profile |</a> </li>
<li>  <a  href="home.jsp">Examination Seating Arrangement |</a> </li>
<li>  <a  href="adminmain.html">Change Password |</a> </li>
<li>  <a  href="adminmain.html">Logout |</a> </li>
 </ul>
    </div>
...
<div class="heading1"><h1>Change Password</h1></div></br></br><br/><br/>
	...
	<hr></br></br><a href="#"><input type="submit" name="sub" value="Change Password Admin" id="butt"></a><br/><br/></font>
